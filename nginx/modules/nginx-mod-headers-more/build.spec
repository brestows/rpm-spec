...
Source1:        https://github.com/openresty/%{modname}-nginx-module/archive/v%{version}/%{modname}-nginx-module-%{version}.tar.gz
...
%setup -q -T -D -b 1 -n %{modname}-nginx-module-%{version}
cp -p %{SOURCE2} .
